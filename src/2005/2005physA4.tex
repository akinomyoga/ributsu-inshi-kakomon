...
\item 
  \begin{enumerate}
  \item 具体的に自分で図を描いて調べてみましょう。すると表\ref{tbl:2005phys4a_1}のようになります。
    \begin{table}
      \begin{center}
        \caption{$n$ ステップでの$G(n)$と$E(n)$}
        \label{tbl:2005phys4a_1}
  ...
  \item 入射エネルギー$E_0$に対して電子、陽電子の走行距離は
    ...
    \sum^{n-1}_{i=0}E(i)X_0
    \end{equation}
    だから、走行距離は表\ref{tbl:2005phys4a_2}のようになる。
    \begin{table}
      \begin{center}
        \caption{入射エネルギーと走行距離との関係}
        \label{tbl:2005phys4a_2}
