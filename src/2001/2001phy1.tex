...
\begin{eqnarray}
  a &=& \sqrt {\frac{{m\omega }}{{2\hbar }}} \hat x + \frac{{\rm i}}{{\sqrt {2m\hbar \omega } }}\hat p , \label{(2)}\\ 
%%原文にはないが，ここに","を入れた。また虚数単位にはsolidのiを使った。
  & & \cr
  a^{\dagger}  &=& \sqrt {\frac{{m\omega }}{{2\hbar }}} \hat x - \frac{{\rm i}}{{\sqrt {2m\hbar \omega } }}\hat p \label{(3)}
\end{eqnarray}
を用いて調べることが出来る。以下の問に，解答に至る筋道を添えて答えよ。\\

\begin{enumerate}
%%%%%%【1.】%%%%%%
  \item 　$(\ref{(1)})$式のハミルトニアンを$a,a^{\dagger}$を用いて表せ。また，$a,a^{\dagger}$の物理的意味を述べよ。\\
