...
#    	System: CYGWIN_NT-5.1 1.5.14(0.126/4/2)
#    
...
set xrange [ * : * ] noreverse nowriteback  # (currently [0.0000:10.0000] )
...
p(x)=sqrt(x**2+2*m*V/(h*h))
T(x)=1/(1+0.25*(2*m*V/(h*h))**2*(sin(p(x)*a))**2/(x*x*p(x)*p(x)))
h = 1.0
V = 5
m = 5
a = 1.0
