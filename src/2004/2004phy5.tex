...
\begin{document}
\begin{question}{第５問}{}
放電管のスペクトルを調べるために、分光器を使って図\iref{2004phy5-3}のような実験を行った。放電管から出た発行は、凸レンズによって入り口スリット$S_1$上に集光される。$S_1$を通った光線は、凹面鏡１によって平行光線となり、回折格子$G$に入射する。回折光は凹面鏡２によって出口のスリット$S_2$上に集光されて、光電子増倍管によって検出される。$G$を回転することにより、$S_2$から出てくる光の波長を変化させることができる。
