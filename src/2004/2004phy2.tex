...
図\ref{2004phy2-0}に示したように、金属内部を表す一辺$L$の立方体の箱の中はポテンシャルがゼロで、外部は$V(>0)$になっているものとする。
...
\item
  ...
  \]
  である．今$T=0$であるから$\beta\rightarrow \infty$であり分布関数は図~\ref{fig:fermi}のよう
  になる
  \begin{figure}[htbp]
   \begin{center}
  \resizebox{!}{5cm}{\input{2004phy2-1.tex}}
   \end{center}
...
\item
  ...
  であることである．$v_z$がこの条件を満たすとき，$J_n$は題意により図~\ref{fig:tyo}の直方
  体の中に含まれる電子の総数に等しい．
  \begin{figure}[h]
  \begin{center}
   \input{2004phy2-2.tex}
  \end{center}
