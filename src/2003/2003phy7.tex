...
\begin{eqnarray}
 ...
 = \left[c^2 (p_0^2 + e^2E^2t^2) + m^2c^4\right]^{\frac{1}{2}} \label{7.1}
\end{eqnarray}
...
\begin{eqnarray}
 ...
 \left(\begin{array}{c}
 eEt \\ p_0 \end{array} \right) \label{velosity}
\end{eqnarray}
$v_x(t)$成分を時間積分すると、
\begin{eqnarray*}
 \int^{t}_0 dt^{\prime}
...
まず、$t$と$L$の関係は(\ref{coordinate})から、
\begin{eqnarray*}
 L = \frac{cp}{eE} \sinh^{-1} \left(\frac{ceEt}{\sqrt{m^2c^4+c^2P_0^2}}\right)
\end{eqnarray*}
であり、(\ref{velosity})から$\frac{v_x}{v_y}$も求まり、上式とあわせて
\begin{eqnarray*}
