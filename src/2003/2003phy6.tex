...
\end{eqnarray}
であるから、式(\ref{kyoumei})(\ref{youryou})より、
\[
...
\item 温度が下がると、コンデンサーの平板が熱収縮して式(\ref{youryou})の$S$が減少する。これによって$C_0$が小さくなり、共振振動数$f_0$は上昇する。\par
(注)なお、平板間を支えている支柱が収縮することで$d$も減少することが考えられるが、式(\ref{youryou})の分子の$S$は面積の次元を持つのに対して、分母の$d$は距離の次元であるから、分子がより強く効いて$C_0$は減少するだろう。
...
\label{epsilon}
\end{eqnarray}
である。この2式(\ref{youryou2})(\ref{epsilon})を用いると、共振振動数は次のように書ける。
\begin{eqnarray}
...
& \simeq & (1-\frac{3}{2}\frac{\alpha \rho}{k})f_0 \label{kinnzi}\\
...
$\alpha \rho/k$が1に対して十分に小さい範囲では、式(\ref{kinnzi})が使えるから、
\begin{eqnarray*}
