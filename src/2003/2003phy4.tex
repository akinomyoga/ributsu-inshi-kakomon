...
\item 探査機の$(x,y)$座標系における速度を$(v_x,v_y)$とおくと、$v_xと\phi$の間に次の微分方程式が成立することを示せ。ただし、式(\ref{4_1})を用いてよい。
	\begin{eqnarray}\label{4_2}
	dv_x=-\frac{GM}{vb}\cos\phi d\phi
	\end{eqnarray}
\item 入射前後における角度変化$\theta$が$\tan\frac{\theta}{2}=\frac{GM}{v^2b}$で表されることを示せ。ただし、式(\ref{4_2})を用いてよい。
